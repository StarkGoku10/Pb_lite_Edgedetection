...
def main():
    ...
    Parser.add_argument('--NumEpochs', dest='NumEpochs',type=int, default=3, help='Path to load images from, Default:BasePath')
    Parser.add_argument('--ModelPath', dest='ModelPath', default='Deep_learning_architectures/Checkpoints/DenseNet/', help='Path to load latest model from, Default:ModelPath')
    Parser.add_argument('--BasePath', dest='BasePath', default='Datasets/CIFAR10/Test/', help='Path to load images from, Default:BasePath')
    Parser.add_argument('--LabelsPath', dest='LabelsPath', default='Deep_learning_Architectures/TxtFiles/LabelsTest.txt', help='Path of labels file, Default:./TxtFiles/LabelsTest.txt')
    ...
    for epoch in range(NumEpochs):
        ...
        ModelPath = 'Deep_learning_architectures/Checkpoints/DenseNet/'+str(epoch)+'model.ckpt'
        print(ModelPath)
        ...
        LabelsPathPred = 'Deep_learning_Architectures/TxtFiles/PredOut.txt' # Path to save predicted labels
        ...
        plt.savefig('Deep_learning_Architectures/results/DenseNet/test/Epochs'+str(epoch)+'.png')
        plt.close()
    end = time.time()
